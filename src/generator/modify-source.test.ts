import { createReactComponent, createTestProject, createTSFile } from "../core/create-test-project.ts";
...
describe('type checker', () => {
  it('finds interface errors', () => {
    const { project } = createTSFile('user.ts', `
...
describe('react component transformer', () => {
